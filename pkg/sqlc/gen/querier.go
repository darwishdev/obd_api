...
type Querier interface {
	...
	CentersList(ctx context.Context, arg CentersListParams) ([]CenterInfo, error)
	...
	SessionAttachCodes(ctx context.Context, arg SessionAttachCodesParams) ([]SessionCode, error)
	SessionAttachValues(ctx context.Context, arg SessionAttachValuesParams) ([]SessionValue, error)
	SessionClose(ctx context.Context, sessionID int64) (Session, error)
	SessionCreate(ctx context.Context, arg SessionCreateParams) (Session, error)
	SessionGetCodes(ctx context.Context, sessionID int64) ([]Code, error)
	SessionsList(ctx context.Context, carID int64) ([]SessionsListRow, error)
	...
	WinchClean(ctx context.Context) error
	WinchCreate(ctx context.Context, arg WinchCreateParams) (Winch, error)
	WinchList(ctx context.Context, arg WinchListParams) ([]WinchInfo, error)
}

...
type Querier interface {
	...
	SessionAttachCode(ctx context.Context, arg SessionAttachCodeParams) (SessionCode, error)
	SessionAttachValue(ctx context.Context, arg SessionAttachValueParams) (SessionValue, error)
	...
	SessionsList(ctx context.Context, carID int64) ([]Session, error)

...
func (server *Server) UserUpdate(ctx context.Context, req *connect.Request[obdv1.UserUpdateRequest]) (*connect.Response[obdv1.UserUpdateResponse], error) {
	...
	resp, err := server.userUsecase.UserUpdate(ctx, req.Msg, authPayload.UserId)
	if err != nil {
		return nil, err
	}

...
var file_obd_v1_obd_service_proto_rawDesc = []byte{
	...
	0x75, 0x66, 0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x98,
	0x06, 0x0a, 0x03, 0x4f, 0x62, 0x64, 0x12, 0x45, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x89, 0x01, 0x0a, 0x0a, 0x63, 0x6f,
	0x6d, 0x2e, 0x6f, 0x62, 0x64, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x4f, 0x62, 0x64, 0x53, 0x65, 0x72,
	...
	0x65, 0x76, 0x2f, 0x6f, 0x62, 0x64, 0x5f, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70,
	0x62, 0x2f, 0x6f, 0x62, 0x64, 0x2f, 0x76, 0x31, 0x3b, 0x6f, 0x62, 0x64, 0x76, 0x31, 0xa2, 0x02,
...
var file_obd_v1_obd_service_proto_goTypes = []interface{}{
	...
	(*user.UserCreateResponse)(nil),     // 11: obd.v1.UserCreateResponse
	(*user.UserLoginResponse)(nil),      // 12: obd.v1.UserLoginResponse
	(*user.UserUpdateResponse)(nil),     // 13: obd.v1.UserUpdateResponse
	(*user.UserAuthorizeResponse)(nil),  // 14: obd.v1.UserAuthorizeResponse
	(*car.BrandsListResponse)(nil),      // 15: obd.v1.BrandsListResponse
	(*car.CarCreateResponse)(nil),       // 16: obd.v1.CarCreateResponse
	(*car.CarUpdateResponse)(nil),       // 17: obd.v1.CarUpdateResponse
	(*center.CentersListResponse)(nil),  // 18: obd.v1.CentersListResponse
	(*winch.WinchListResponse)(nil),     // 19: obd.v1.WinchListResponse
	(*review.ReviewsListResponse)(nil),  // 20: obd.v1.ReviewsListResponse
	(*review.ReviewCreateResponse)(nil), // 21: obd.v1.ReviewCreateResponse
}
var file_obd_v1_obd_service_proto_depIdxs = []int32{
	...
	11, // 11: obd.v1.Obd.UserCreate:output_type -> obd.v1.UserCreateResponse
	12, // 12: obd.v1.Obd.UserLogin:output_type -> obd.v1.UserLoginResponse
	13, // 13: obd.v1.Obd.UserUpdate:output_type -> obd.v1.UserUpdateResponse
	14, // 14: obd.v1.Obd.UserAuthorize:output_type -> obd.v1.UserAuthorizeResponse
	15, // 15: obd.v1.Obd.CarBrandsList:output_type -> obd.v1.BrandsListResponse
	16, // 16: obd.v1.Obd.CarCreate:output_type -> obd.v1.CarCreateResponse
	17, // 17: obd.v1.Obd.CarUpdate:output_type -> obd.v1.CarUpdateResponse
	18, // 18: obd.v1.Obd.CentersList:output_type -> obd.v1.CentersListResponse
	19, // 19: obd.v1.Obd.WinchList:output_type -> obd.v1.WinchListResponse
	20, // 20: obd.v1.Obd.ReviewsList:output_type -> obd.v1.ReviewsListResponse
	21, // 21: obd.v1.Obd.ReviewCreate:output_type -> obd.v1.ReviewCreateResponse
